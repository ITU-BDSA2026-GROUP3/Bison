...
namespace Bison.CSVDBService
{
    ...
    public class Program
    {
        ...
        const string baseProposalTableName = "bison_proposal_cli_db";

        static string observationTableName = "";
        static string commentTableName = "";
        static string proposalTableName = "";
        ...
        public static WebApplication getApp(WebApplicationBuilder builder, string[] args)
        {
            ...
            proposalTableName = (args.Count() == 0) ? baseProposalTableName : args[0].ToLower().Equals("test") ? "test_proposal_cli_db" : baseProposalTableName;
